...
public class LiveClassCategoryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_class_category_details);
...
//        blink3.startAnimation(animBlink);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(LiveClassCategoryDetails.this)) {
                    ...
                    Toast.makeText(LiveClassCategoryDetails.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(LiveClassCategoryDetails.this);
...
//                Toast.makeText(getApplicationContext(),response,Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(LiveClassCategoryDetails.this, 1);
                    LiveCategoryDetailsAdapter customerListAdapter = new LiveCategoryDetailsAdapter(LiveClassCategoryDetails.this, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(LiveClassCategoryDetails.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(LiveClassCategoryDetails.this);
