...
public class Das_Live_AyogList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_das__live__ayog_list);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(Das_Live_AyogList.this)) {
                    ...
                    Toast.makeText(Das_Live_AyogList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(Das_Live_AyogList.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BaseURL + "GetAayogList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Das_Live_AyogList.this, 3);
                    LiveAyogListAdapter customerListAdapter = new LiveAyogListAdapter(Das_Live_AyogList.this, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(Das_Live_AyogList.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Das_Live_AyogList.this);
