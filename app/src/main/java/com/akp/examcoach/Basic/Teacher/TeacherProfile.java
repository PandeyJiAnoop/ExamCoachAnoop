...
import com.akp.examcoach.Basic.slidingmenu.ChangePassword;
...
public class TeacherProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_pass_ll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), TeacherChangePassword.class);
                startActivity(intent);
            }
        });
    ...
    private void SaveProfileAPI() {
        final ProgressDialog progressDialog = new ProgressDialog(TeacherProfile.this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BaseURL + "UpdateTeacherProfile", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(TeacherProfile.this, object.getString("msg"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(TeacherProfile.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("TeacherName", name_et.getText().toString());
                ...
                params.put("FatherName",fname_et.getText().toString());
    ...
    private void ViewProfileAPI() {
        ...
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BaseURL + "GetTeacherProfile", new Response.Listener<String>() {
            //        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.Signature_BASE_URL + url, new  Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                progressDialog.dismiss();
...
//                    Toast.makeText(MyProfile.this, object.getString("msg"), Toast.LENGTH_SHORT).show();
                    ...
                    name_et.setText(object.getString("TeacherName"));
