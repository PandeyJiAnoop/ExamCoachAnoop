    ...
    public void changePassword() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BaseURL + "ChangePassword", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (object.getString("msg").equalsIgnoreCase("Success")) {
                        ...
                        Toast.makeText(TeacherChangePassword.this, object.getString("msg"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(TeacherChangePassword.this, "Internet connection is slow Or no internet connection", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
...
//                params.put("confirm_password", edt_conf_pass.getText().toString().trim());
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TeacherChangePassword.this);
