...
//            });
            //REMOTE RESOURCE
            mWebView.loadUrl("http://examcoach.in/privacy.html");
        }
    ...
    /*    cust_recyclerView=findViewById(R.id.cust_recyclerView);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(PrivacyPolicy.this)) {
                    ...
                    Toast.makeText(PrivacyPolicy.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
//        getHistory();
    ...
    public void getHistory() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArrayr.length(); i++) {
                        ...
                        hm.put("Heading", jsonObject1.getString("Heading"));
                        hm.put("Content", jsonObject1.getString("Content"));
                        arrayList1.add(hm);
                    }
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(PrivacyPolicy.this, 1);
                    FAQAdapter customerListAdapter = new FAQAdapter(PrivacyPolicy.this, arrayList1);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PrivacyPolicy.this, "Something went wrong!"+error, Toast.LENGTH_SHORT).show();
            }        });
