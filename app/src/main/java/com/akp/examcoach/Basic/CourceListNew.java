...
public class CourceListNew extends AppCompatActivity {
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cource_list_new);
...
//        blink3.startAnimation(animBlink);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(CourceListNew.this)) {
                    ...
                    Toast.makeText(CourceListNew.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(CourceListNew.this);
...
//                Toast.makeText(CourceListNew.this, "Something went wrong:-" + response, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(CourceListNew.this, 3);
                    LiveCategoryAdapter customerListAdapter = new LiveCategoryAdapter(CourceListNew.this, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(CourceListNew.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CourceListNew.this);
