...
public class Das_LiveClassEbook extends AppCompatActivity {
    ...
    String getAayogId,getAayogTitle;
    SwipeRefreshLayout srl_refresh;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_das__live_class_ebook);
...
//        blink3.startAnimation(animBlink);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(Das_LiveClassEbook.this)) {
                    ...
                    Toast.makeText(Das_LiveClassEbook.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(Das_LiveClassEbook.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BaseURL + "CourseList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Das_LiveClassEbook.this, 3);
                    LiveCategoryAdapterEbook customerListAdapter = new LiveCategoryAdapterEbook(Das_LiveClassEbook.this, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(Das_LiveClassEbook.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Das_LiveClassEbook.this);
