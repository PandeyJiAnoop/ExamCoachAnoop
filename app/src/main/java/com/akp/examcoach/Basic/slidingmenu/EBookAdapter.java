...
public class EBookAdapter extends RecyclerView.Adapter<EBookAdapter.VH> {
    Context context;
    ...
    public EBookAdapter(Context context, List<HashMap<String, String>> arrayList) {
    ...
    @NonNull
    @Override
    public EBookAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.dynamic_ebook, viewGroup, false);
        EBookAdapter.VH viewHolder = new EBookAdapter.VH(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull EBookAdapter.VH vh, int i) {
