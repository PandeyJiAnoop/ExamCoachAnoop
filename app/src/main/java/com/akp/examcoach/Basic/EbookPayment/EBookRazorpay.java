package com.akp.examcoach.Basic.EbookPayment;
...
public class EBookRazorpay extends AppCompatActivity implements PaymentResultListener {
    String UserId;
    TextView status_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_book_razorpay);
...
//            checkout.setKeyID("rzp_test_VTsuHqMX7VGC4t");
         ...
         */
        final Activity activity = EBookRazorpay.this;
...
//            options.put("order_id", "order_DBJOWzybf0sJbb");//from response of step 3.
            ...
            checkout.open(EBookRazorpay.this, options);
...
//        result.setText("Transaction ID : "+s);
        Toast.makeText(EBookRazorpay.this, "Payment DONE Successfully!\n"+"Transaction ID : "+s,Toast.LENGTH_SHORT).show();
    }
    @Override
    public void onPaymentError(int i, String s) {
        getHistory(getPackid,getorderid,"FAILED",s);
        status_tv.setText("ERROR : "+s);
        Toast.makeText(EBookRazorpay.this, "ERROR : "+s,Toast.LENGTH_SHORT).show();
    }
    ...
    public void getHistory(String packid,String orderid, String pstatus,String refid) {
        final ProgressDialog progressDialog = new ProgressDialog(EBookRazorpay.this);
...
//                Toast.makeText(getApplicationContext(),response,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EBookRazorpay.this, "Something went wrong!"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(EBookRazorpay.this);
