...
public class LiveClassCategoryDetailsELibrary extends AppCompatActivity {
    ...
    TextView txt_nodata;
    String getSubjectId,getSubjectName,getHomecatId;
    TextView totle_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_class_category_details_e_library);
...
//        blink3.startAnimation(animBlink);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(LiveClassCategoryDetailsELibrary.this)) {
                    ...
                    Toast.makeText(LiveClassCategoryDetailsELibrary.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(LiveClassCategoryDetailsELibrary.this);
...
//                Toast.makeText(getApplicationContext(),response,Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(LiveClassCategoryDetailsELibrary.this, 1);
                    LiveCategoryDetailsAdapterELibrary customerListAdapter = new LiveCategoryDetailsAdapterELibrary(LiveClassCategoryDetailsELibrary.this, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(LiveClassCategoryDetailsELibrary.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(LiveClassCategoryDetailsELibrary.this);
